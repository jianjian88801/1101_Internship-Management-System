               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="分享标题" prop="shixiFenxiangName">
                       <el-input v-model="ruleForm.shixiFenxiangName"
                                 placeholder="分享标题" clearable  :readonly="ro.shixiFenxiangName"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.shixiFenxiangPhoto" label="分享照片" prop="shixiFenxiangPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.shixiFenxiangPhoto?ruleForm.shixiFenxiangPhoto:''"
                            @change="shixiFenxiangPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="分享类型" prop="shixiFenxiangTypes">
                        <el-select v-model="ruleForm.shixiFenxiangTypes" :disabled="ro.shixiFenxiangTypes" placeholder="请选择分享类型">
                            <el-option
                                v-for="(item,index) in shixiFenxiangTypesOptions"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="分享内容" prop="shixiFenxiangContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.shixiFenxiangContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.shixiFenxiangContent" label="分享内容" prop="shixiFenxiangContent">
                            <span v-html="ruleForm.shixiFenxiangContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    xueshengId: false,
                    shixiFenxiangName: false,
                    shixiFenxiangPhoto: false,
                    shixiFenxiangTypes: false,
                    shixiFenxiangClicknum: false,
                    shixiFenxiangContent: false,
                    shixiFenxiangDelete: false,
                },
                ruleForm: {
                    xueshengId: '',
                    shixiFenxiangName: '',
                    shixiFenxiangPhoto: '',
                    shixiFenxiangTypes: '',
                    shixiFenxiangClicknum: '',
                    shixiFenxiangContent: '',
                    shixiFenxiangDelete: '',
                },
                shixiFenxiangTypesOptions : [],
                xueshengOptions : [],
                rules: {
                   xueshengId: [
                   ...
                   shixiFenxiangPhoto: [
                              { required: true, message: '分享照片不能为空', trigger: 'blur' },
                          ],
                   shixiFenxiangTypes: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=shixi_fenxiang_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shixiFenxiangTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`shixiFenxiang/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.shixiFenxiangCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            shixiFenxiangPhotoUploadChange(fileUrls){
                this.ruleForm.shixiFenxiangPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
