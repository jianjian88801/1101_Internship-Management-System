...
public class ShixiZhoubaoView extends ShixiZhoubaoEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 第几周的值
		*/
		private String shixiZhoubaoValue;
	...
	public ShixiZhoubaoView() {

	}

	public ShixiZhoubaoView(ShixiZhoubaoEntity shixiZhoubaoEntity) {
		try {
			BeanUtils.copyProperties(this, shixiZhoubaoEntity);
			...
			* 获取： 第几周的值
			*/
			public String getShixiZhoubaoValue() {
				return shixiZhoubaoValue;
			}
			/**
			* 设置： 第几周的值
			*/
			public void setShixiZhoubaoValue(String shixiZhoubaoValue) {
				this.shixiZhoubaoValue = shixiZhoubaoValue;
			}
