...
public class ShixiFenxiangCollectionView extends ShixiFenxiangCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String shixiFenxiangCollectionValue;
	...
	public ShixiFenxiangCollectionView() {

	}

	public ShixiFenxiangCollectionView(ShixiFenxiangCollectionEntity shixiFenxiangCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, shixiFenxiangCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getShixiFenxiangCollectionValue() {
				return shixiFenxiangCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setShixiFenxiangCollectionValue(String shixiFenxiangCollectionValue) {
				this.shixiFenxiangCollectionValue = shixiFenxiangCollectionValue;
			}
