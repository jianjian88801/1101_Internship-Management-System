    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="单位名称" prop="shixiName">
                       <el-input v-model="ruleForm.shixiName"
                                 placeholder="单位名称" clearable  :readonly="ro.shixiName"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="单位地址" prop="shixiAddress">
                       <el-input v-model="ruleForm.shixiAddress"
                                 placeholder="单位地址" clearable  :readonly="ro.shixiAddress"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="单位地址" prop="shixiAddress">
                           <el-input v-model="ruleForm.shixiAddress"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="单位性质" prop="shixiTypes">
                        <el-select v-model="ruleForm.shixiTypes" :disabled="ro.shixiTypes" placeholder="请选择单位性质">
                            <el-option
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="实习开始时间" prop="kaishiTime">
                        <el-date-picker
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.kaishiTime" label="实习开始时间" prop="kaishiTime">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="实习结束时间" prop="jieshuTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.jieshuTime" label="实习结束时间" prop="jieshuTime">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.shixiYesnoTypes" label="审核状态" prop="shixiYesnoTypes">
                        <el-input v-model="ruleForm.shixiYesnoValue" placeholder="审核状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.shixiYesnoText" label="审核意见" prop="shixiYesnoText">
                        <span v-html="ruleForm.shixiYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
                <!--<el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="审核时间" prop="unpdateTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.unpdateTime"
                                type="datetime"
                                placeholder="审核时间"
                                :disabled="ro.unpdateTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.unpdateTime" label="审核时间" prop="unpdateTime">
                            <span v-html="ruleForm.unpdateTime"></span>
                        </el-form-item>
                    </div>
                </el-col>-->
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    jieshuTime: false,
                    shixiContent: false,
                    shixiYesnoTypes: false,
                    shixiYesnoText: false,
                    unpdateTime: false,
                    insertTime: false,
                },
                ruleForm: {
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=shixi_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shixiYesnoTypesOptions = data.data.list;
                    }
                });
